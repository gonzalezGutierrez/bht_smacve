...
(function (window, $, undefined) {
	...
	$.html5imageupload = function html5imageupload(options, element) {
		...
		this.button.saving		= '<div class="btn btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="far fa-clock"></i></div>';
		this.button.zoomin		= '<div class="btn btn-light btn-zoom-in" title="' + (this.options.zoominTitle || 'Zoom in') + '"><i class="fas fa-search-plus"></i></div>';
		this.button.zoomout		= '<div class="btn btn-light btn-zoom-out" title="' + (this.options.zoomoutTitle || 'Zoom out') + '"><i class="fas fa-search-minus"></i></div>';
		this.button.zoomreset	= '<div class="btn btn-light btn-zoom-reset" title="' + (this.options.zoomresetTitle || 'Fullsize') + '"><i class="fas fa-expand-arrows-alt"></i></div>';
//		this.button.rotatecw	= '<div class="btn btn-light btn-rotate-cw" title="' + (this.options.cwTitle || 'Rotate clockwise') + '"><i class="glyphicon glyphicon-share"></i></div>';
//		this.button.rotateccw	= '<div class="btn btn-light btn-rotate-ccw" title="' + (this.options.ccwTitle || 'Rotate counter clockwise') + '"><i class="glyphicon glyphicon-share icon-flipped"></i></div>';
		this.button.cancel		= '<div class="btn btn-danger btn-cancel" title="' + (this.options.cancelTitle || 'Cancel') + '"><i class="fas fa-times"></i></div>';
		this.button.done		= '<div class="btn btn-success btn-ok" title="' + (this.options.okTitle || 'Ok') + '"><i class="fas fa-check"></i></div>';
		this.button.del			= '<div class="btn btn-danger btn-del" title="' + (this.options.delTitle || 'Delete') + '"><i class="fas fa-trash-alt"></i></div>';
		
		this.button.download	= '<a class="btn btn-warning download"><i class="fas fa-download"></i> ' + (this.options.downloadLabel || 'Download') + '</a>';
