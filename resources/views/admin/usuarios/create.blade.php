...
@section('content')
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    {!! Form::open(['url'=>'admin/usuarios','method' => 'POST', 'id'=>'FormNuevoUsuario','class'=>''])!!}
                    <div class="card">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div style="display: block; position: relative;">
                                                    <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                                        <input id="fechaNacimiento" name="fechaNacimiento" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker1" placeholder="Fecha Nacimiento" readonly/>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                {!!Form::select('sexo', array('M' => 'MASCULINO', 'F' => 'FEMENINO'),'M', ['class' => 'form-control '])!!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('idEstado', $estados, 9, ['placeholder' => 'Estado','class'=>'form-control']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('idPais', $paises, 1, ['placeholder' => 'País','class'=>'form-control']) !!}
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!!Form::select('idRol',$roles_lists,3, ['class' => 'form-control'])!!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!!Form::select('idCargo',$cargos_lists,25, ['class' => 'form-control'])!!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!!Form::select('idStatusSocio',$status_lists,1, ['class' => 'form-control'])!!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-right">
                                            <div class="form-group">
                                                {!! Form::submit('Registrar', ['id'=>'btnEnviar','class' => 'btn btn-dark btn-lg']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('javascript')
    ...
    <script src="{{ asset('js/admin/usuarios/usuarios_create.js') }}"></script>
@endsection
