...
@section('content')
    ...
    <section class="area-contenido">
        ...
        <div class="row">
                <div class="col-sm-12">
                    {!! Form::model($post,['url'=>'admin/educacion_medica/'.$post->idPost,'method' => 'PATCH', 'id'=>'FormEditarPost'])!!}
                    <div class="card">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="display: block; position: relative;">
                                            <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                                <input id="fechaPublicacion" name="fechaPublicacion" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker1" value="{{date('d/m/Y H:i:s',strtotime($post->fechaPublicacion))}}"/>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="contenedor-upload-image">
                                        <div class="dropzone"
                                             ...
                                             data-height="500"
                                             data-canvas="true"
                                             data-image="{{ asset('images/educacion_medica/thumb_post/'.$post->thumb) }}" >
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    {!! Form::text('editor',$post->contenido,['class'=>'form-control', 'id'=>'editor']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input id="imagen_hidden" type="hidden" value="{{$post->images}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group {{ $errors->has('video') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                {!! Form::text('video_text',$post->videos,['class'=>'form-control','id'=>'video_text']) !!}
                                                <div class="input-group-btn">
                                    ...
                                    <input id="video_hidden" type="hidden" value="{{$post->videos}}">
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('javascript')
            ...
            <script src="{{ asset('js/admin/educacion_medica/educacion_medica_edit.js') }}"></script>
@endsection
