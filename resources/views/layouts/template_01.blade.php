...
<head>
    ...
    <link href="{{asset('libraries/animate-3.6.0/animate.css')}}" rel="stylesheet" >
    <link href="{{asset('libraries/fontawesome-5.5.0/css/all.min.css')}}" rel="stylesheet">
    <link href="{{asset('libraries/et-line/et-line.css')}}" rel="stylesheet">
    <link href="{{asset('libraries/icomoon/icomoon.css')}}" rel="stylesheet">
    <link href="{{asset('libraries/jquery.magnific-popup/magnific-popup.css')}}" rel="stylesheet">

    <link href="{{asset('libraries/owl_carousel_2-2.3.4/assets/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{asset('libraries/owl_carousel_2-2.3.4/assets/owl.theme.default.min.css')}}" rel="stylesheet">

    <link href="{{asset('libraries/xzoom/xzoom.css')}}" rel="stylesheet">
    ...
    <!-- custom css -->
    <link rel="stylesheet" type="text/css" href="{{asset('css/template_01.css?v='.time())}}" />
    ...
    <header>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 p-0">
                        <div id="dropdownMenuUser" class="dropdown">
                            <button class="dropdown-toggle" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                @guest
                                    Acceso a Miembros
                                @else
                                    {{ Auth::user()->titulo }} {{ Auth::user()->nombre }} {{ Auth::user()->apellidoPaterno }} {{ Auth::user()->apellidoMaterno }}
                                @endguest
                            </button>
                            <div class="dropdown-menu">
                                @guest
                                    <a class="dropdown-item" href="{{ route('login') }}">Iniciar Sesión</a>
                                    <a class="dropdown-item" href="{{ route('register') }}">Nuevo Registro</a>
                                @else
                                    @if( Auth::user()->idRol == 1)
                                        <a class="dropdown-item" href="{{ asset('admin') }}">Área de Administración</a>
                                    @endif
                                    <a class="dropdown-item" href="{{ asset('mi_cuenta') }}">Mi Cuenta</a>
                        ...
                        <div id="dropdownCAV2019" class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{asset('requisitos_2021/convocatoria')}}">Requisitos  globales de convocatoria 2021</a>
                                <a class="dropdown-item" href="{{asset('pdf/convocatoria_2021.pdf')}}" target="_blank">Convocatoria de participación 2021</a>
                            </div>
                        </div>
        ...
        <div class="navbar-default">
            <div class="top-search bg-theme">
                <div class="container">
                    <form class="search-form" action="{{asset('/')}}" method="GET" accept-charset="utf-8">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light no-padding">
                                ...
                                <div class="navbar-header navbar-header-custom">
                                    <a href="{{asset('/')}}" class="navbar-brand">
                                        <img id="logo" src="{{asset('images/logos/logo_smacve.png')}}" alt="SMACVE" />
                                ...
                                <ul class="navbar-nav ml-auto" id="nav" style="display: none;">
                                    <li id="btn-inicio" class="btn-section"><a href="{{asset('/')}}">Inicio</a></li>
                                    <li id="btn-acerca-de" class="btn-section" >
                                        <a href="javascript:void(0)">ACERCA DE</a>
                                        <ul>
                                            <li><a href="{{asset('acerca_de/quienes_somos')}}">Quienes Somos</a></li>
                                            <li><a href="{{asset('acerca_de/mesa_directiva')}}">Mesa Directiva</a></li>
                                            <li><a href="{{asset('acerca_de/miembros')}}">Miembros Activos</a></li>
                                            <li><a href="{{asset('acerca_de/expresidentes')}}">Expresidentes</a></li>
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{asset('acerca_de/codigos_etica/politica_conflictos')}}">Política de Conflictos</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="{{asset('acerca_de/convenios')}}">Convenios</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    @guest
                                        <li id="btn-atencion-al-socio" class="btn-section"><a href="javascript:void(0)">Atención al Socio</a>
                                            <ul>
                                                ...
                                                <li><a href="{{asset('atencion_socio/pago_anualidad')}}">Pago de Anualidad 2020</a></li>
                                                <li>
                                                    <a href="javascript:void(0)">Actas de Asamblea</a>
                                                    <ul>
                                                        <li><a target="_blank" href="{{asset('documentos/acta_asamblea_negocios.pdf')}}">Acta de Asamblea de Negocios Vallarta 2018</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    ...
                                                    <ul>
                                                        <!--
                                                        <li><a target="_blank" href="{{asset('documentos/convocatorias/convocatoria_asamblea_general_ordinaria.pdf')}}">Convocatoria a Asamblea General Ordinaria</a></li>
                                                        <li><a target="_blank" href="{{asset('documentos/convocatorias/convocatoria_asamblea_extraordinaria.pdf')}}">Convocatoria a Asamblea Extraordinaria</a></li>
                                                        <li><a target="_blank" href="{{asset('documentos/convocatorias/convocatoria_comisionados_honor_justicia.pdf')}}">Convocatoria Comisionados Honor y Justicia</a></li>
                                                        <li><a target="_blank" href="{{asset('documentos/convocatorias/convocatoria_comisarios.pdf')}}">Convocatoria Comisarios</a></li>
                                                        <li><a target="_blank" href="{{asset('documentos/convocatorias/convocatoria_vocalias.pdf')}}">Convocatoria Vocalías</a></li>
                                                        <li><a target="_blank" href="{{asset('documentos/convocatorias/convocatoria_vicepresidente.pdf')}}">Convocatoria Vicepresidente</a></li>
                                                        -->
                                                    </ul>
                                                </li>
                                    ...
                                    @else
                                        <li id="btn-atencion-al-socio" class="btn-section"><a href="javascript:void(0)">Mi Cuenta</a>
                                            <ul>
                                                ...
                                                <li><a href="{{asset('mi_cuenta/herramientas_para_socios')}}">Herramientas para Socios</a></li>
                                                <li><a href="{{asset('mi_cuenta/anualidades')}}">Mis Anualidades</a></li>
                                                <li><a href="{{asset('mi_cuenta/informacion_pago')}}">Información para Pagos</a></li>
                                    ...
                                    <li id="btn-investigacion" class="btn-section" >
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{asset('investigacion/comision_actualizacion_gpc/nacionales')}}">Comisión de actualización de GPC</a></li>
                                        <li><a href="{{asset('investigacion/comite_promocion/')}}">Comité de promoción y profesionalización de la investigación</a></li>
                                    ...
                                    <li id="btn-educacion_medica" class="btn-section" >
                                        ...
                                        <ul>
                                            <li><a href="{{asset('educacion_medica')}}">Webinars y Conferencias</a></li>
                                            <li><a href="{{asset('educacion_medica/comision_cirujanos_vasculares_jovenes')}}">Comité de Cirujanos Vasculares Jovenes</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="btn-boletin" class="btn-section" >
                                        ...
                                        <ul>
                                            <li><a href="{{asset('boletines/sexta_edicion')}}">Sexta Edición</a></li>
                                            <li><a href="{{asset('boletines/quinta_edicion')}}">Quinta Edición</a></li>
                                            <li><a href="{{asset('boletines/cuarta_edicion')}}">Cuarta Edición</a></li>
                                            <li><a href="{{asset('boletines/tercera_edicion')}}">Tercera Edición</a></li>
                                            <li><a href="{{asset('boletines/segunda_edicion')}}">Segunda Edición</a></li>
                                            <li><a href="{{asset('boletines/primera_edicion')}}">Primera Edición</a></li>
                                        </ul>
                                    </li>
                                    <li id="btn-eventos" class="btn-section">
                                        <a href="javascript:void(0)">Eventos</a>
                                        <ul>
                                            <li><a href="{{asset('eventos')}}">Eventos internacionales</a></li>
                                            <li><a href="{{asset('seminarios-residentes')}}">Seminarios Residentes</a></li>
                                            <li><a href="{{asset('sesiones_academicas')}}">Sesiones Academicas</a></li>
                                        </ul>
                                    </li>
                                    <li id="btn-contacto" class="btn-section"><a href="{{asset('contacto')}}">Contacto</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="padding-30px-all sm-padding-25px-tb sm-no-padding-lr border-right border-color-light-white sm-no-border-right sm-border-bottom">
                            ...
                            <div class="d-inline-block vertical-align-top padding-10px-left width-75">
                                ...
                                <a href="{{asset('mi_cuenta')}}" class="no-margin line-height-normal">Accesa a cuenta</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="padding-30px-all sm-padding-25px-tb sm-no-padding-lr border-right border-color-light-white sm-no-border-right sm-border-bottom">
                            ...
                            <div class="d-inline-block vertical-align-top padding-10px-left width-75">
                                ...
                                <a href="{{asset('atencion_socio/pago_anualidad')}}" class="no-margin line-height-normal">Cuota 2021: $3,600.00</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="padding-30px-all sm-padding-25px-tb sm-no-padding-lr">
                            ...
                            <div class="d-inline-block vertical-align-top padding-10px-left width-75">
                                ...
                                <a href="{{asset('contacto')}}" class="no-margin line-height-normal">Será un placer atenderte</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 sm-margin-30px-bottom">
                    <div class="text-center">
                        <img class="footer-logo" alt="SMACVE" src="{{asset('images/logos/logo_smacve_white.png')}}">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 no-padding-right xs-padding-15px-right">
                            <ul class="footer-list">
                                ...
                                <li><a href="{{asset('atencion_socio/estatutos')}}">Estatutos SMACVE</a></li>
                                <li><a href="{{asset('atencion_socio/pago_anualidad')}}">Anualidad SMACVE</a></li>
                                <li><a href="{{asset('acerca_de/codigos_etica/aviso_privacidad')}}">Aviso de Privacidad</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right xs-text-center">
                        <p class="xs-margin-5px-top xs-font-size13">© 2021 smacve.org.mx By <a href="{{asset('https://bht.mx')}}">Black Horse Technologies</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{asset('libraries/jquery.magnific-popup/jquery.magnific-popup.min.js')}}" type="text/javascript"></script>
<script src="{{asset('libraries/easy.responsive.tabs/easy.responsive.tabs.js')}}"></script>

<script src="{{asset('libraries/owl_carousel_2-2.3.4/owl.carousel.min.js')}}" type="text/javascript"></script>


<script src="{{asset('libraries/jquery.counterup/jquery.counterup.min.js')}}" type="text/javascript"></script>
<script src="{{asset('libraries/jquery.stellar/jquery.stellar.js')}}" type="text/javascript"></script>
<script src="{{asset('libraries/jquery.tabs/tabs.min.js')}}" type="text/javascript"></script>
<script src="{{asset('libraries/isotope.pkgd/isotope.pkgd.min.js')}}" type="text/javascript"></script>
<script src="{{asset('libraries/jquery.waypoints/jquery.waypoints.min.js')}}" type="text/javascript"></script>


<script src="{{asset('js/template_01.js?v='.time())}}" type="text/javascript"></script>
