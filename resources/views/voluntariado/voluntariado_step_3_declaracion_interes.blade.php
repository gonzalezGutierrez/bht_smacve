                        ...
                        <ul class="no-margin">
                            ...
                            @if(!empty($puestoSeleccionados))
                                @foreach($puestoSeleccionados as $puesto )
                                    ...
                                    <li class="{{$class}}"><a href="{{asset('voluntariado/step_3/'.$puesto->ordenSeleccion)}}">{{$puesto->puestoVoluntariado}} - Declaración de Interés</a></li>
                                @endforeach
                            @endif
                ...
                <div class="col-lg-8 col-md-7 col-sm-12">
                    ...
                    @endif
                        ...
                        <div class="section-heading half left">
                            <h4>{{$puestoActivo->puestoVoluntariado}} - Declaración de Interés</h4>
                        </div>
                        ...
                        <div class="bg-white padding-20px-all sm-padding-20px-all border border-width-5">
                            ...
                            {!!  Form::model($puestoActivo,['url' => 'voluntariado/step_3/'.$puestoActivo->ordenSeleccion, 'method' => 'POST',  'id' => 'voluntariado', 'class'=>'contact-form' ]) !!}

                            <div class="form-group row">
                                <div class="col-md-12">
                                    {!! Form::label('declaracionInteres', 'Declaración de Interés:',['class'=>'']) !!}
                                </div>
                                <div class="col-md-12">
                                    {!! Form::textArea('declaracionInteres',null,['class'=>'form-control ','placeholder'=>'','rows'=>5]) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    {!! Form::label('aptitudes', 'Aptitudes y Experiencia:',['class'=>'']) !!}
                                </div>
                                <div class="col-md-12">
                                    {!! Form::textArea('aptitudes',null,['class'=>'form-control ','placeholder'=>'','rows'=>5]) !!}
                                </div>
                            </div>
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ asset('js/voluntariado/voluntariado_step_3_declaracion_interes.js') }}"></script>
