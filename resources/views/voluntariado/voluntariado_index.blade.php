...
@section('title','Solicitud de Voluntariado')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-sm-12">
                    <div class="alert alert-success">
                        <strong>Muchas gracias a los que participaron ¡La sociedad son ustedes!</strong>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 ">
                    ...
                    <!--<div class="text-center">
                        <a class="butn theme medium" href="{{asset('voluntariado/step_1')}}"><span>Iniciar la Solicitud</span></a>
                    </div>-->
                </div>
            </div>
        </div>
