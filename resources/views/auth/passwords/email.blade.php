            ...
            <div class="row">
                <div class="col-lg-6 center-col">
                    ...
                    <div class="bg-white padding-30px-all sm-padding-20px-all border border-width-5">
                        ...
                        {!! Form::open(['url'=>'password/email','method' => 'POST', 'id'=>'FormRegister','class'=>'contact-form'])!!}
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row ">
                            <div class="col-sm-12 text-center">
                                <div class="form-group mt-4">
                                    <button class="butn theme medium" type="submit"><span>Enviar Link para Resetear Contraseña</span></button>
                                </div>
                            </div>
                        </div>
                        {!! Form::close()!!}
