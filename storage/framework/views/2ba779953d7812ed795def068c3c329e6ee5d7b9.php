            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-12 padding-50px-right md-padding-30px-right sm-padding-15px-right">
                    ...
                    <div class="single-sidebar-menu">
                        <ul class="no-margin">
                            ...
                            <li><a href="<?php echo e(asset('voluntariado/step_4')); ?>">Politicas de Divulgación</a></li>
                            <li class="active"><a href="<?php echo e(asset('voluntariado/step_5')); ?>">Revisar y Enviar</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-8 col-md-7 col-sm-12">
                    ...
                    <?php endif; ?>
                        ...
                        <?php echo Form::model($solicitud,['url' => 'voluntariado/step_5', 'method' => 'POST',  'id' => 'voluntariado', 'class'=>'contact-form' ]); ?>
