<?php $__env->startSection('title','Guías Clínicas'); ?>

<?php $__env->startSection('content'); ?>

    <section class="page-title-section bg-img cover-background" data-overlay-dark="4" data-background="<?php echo e(asset('images/bg/bg_atencion_socio.jpg')); ?>">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-12 padding-50px-right md-padding-30px-right sm-padding-15px-right">
                    ...
                    <div class="single-sidebar-menu">
                        <ul class="no-margin">
                            <li class="active"><a href="<?php echo e(asset('atencion_socio/guias_clinicas')); ?>">Guías Clínicas</a></li>
                            <li><a href="<?php echo e(asset('atencion_socio/estatutos')); ?>">Estatutos</a></li>
                            <li><a href="<?php echo e(asset('atencion_socio/pago_anualidad')); ?>">Pago de Anualidad</a></li>
                        </ul>
                    </div>
                    <div class="bg-img cover-background theme-overlay border-radius-5 margin-30px-bottom sm-margin-25px-bottom" data-overlay-dark="8" data-background="<?php echo e(asset('images/bg/bg2.jpg')); ?>" >
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class=list-guia-img>
                                    <img alt=img src="<?php echo e(asset('images/atencion_socio/guias_clinicas.jpg')); ?>" class="img-fluid" />
                                </div>
