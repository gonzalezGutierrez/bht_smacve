<?php $__env->startSection('title','Comité de promoción y profesionalización de la investigación'); ?>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-5 col-sm-12 padding-50px-right md-padding-30px-right sm-padding-15px-right">
                ...
                <div class="single-sidebar-menu">
                    <ul class="no-margin">
                        <li class="<?php if($section=='proyectos_nacionales'): ?> active <?php endif; ?>"><a href="<?php echo e(asset('investigacion/comite_promocion/proyectos_nacionales')); ?>">Proyectos nacionales</a></li>
                        <li class="<?php if($section=='proyectos_internacionales'): ?> active <?php endif; ?>"><a href="<?php echo e(asset('investigacion/comite_promocion/proyectos_internacionales')); ?>">Proyectos internacionales</a></li>
                        <li class="<?php if($section=='profesionalizacion_investigacion'): ?> active <?php endif; ?>"><a href="<?php echo e(asset('investigacion/comite_promocion/profesionalizacion_investigacion')); ?>">Profesionalización de la investigación</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-8 col-lg-8 col-xs-12">
                ...
                <?php endif; ?>
                <?php if($section == 'profesionalizacion_investigacion'): ?>
                    <div class="">
                        <img class="image-book" src="<?php echo e(asset('images/libros/libro_proyectos_internacionales.png')); ?>" class="img-responsive" alt="">
                        <br>
                        <a href="<?php echo e(asset('pdf/libros/designing_clinical_research.pdf')); ?>" target="_blank" class="btn text-white text-uppercase mt-3" style="background:rgb(150, 125, 61);">
                            Descargar libro
                        </a>
                    </div>
                <?php endif; ?>
                <?php if($section == 'proyectos_nacionales'): ?>
                    <div class="">
                ...
                <?php if($section == 'proyectos_internacionales'): ?>
