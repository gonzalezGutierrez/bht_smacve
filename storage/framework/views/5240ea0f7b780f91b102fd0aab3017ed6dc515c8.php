            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <ul>
                        ...
                        <li><a href="<?php echo e(asset('mi_cuenta/anualidades')); ?>">Anualidades</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 col-sm-12">
                    <div class="bg-white padding-30px-all sm-padding-20px-all border border-width-5">
                        ...
                        <?php echo Form::open(['url'=>'mi_cuenta/payment/'.$idAnualidad,'method' => 'POST', 'id'=>'FormRegister','class'=>'contact-form','id'=>'formPay']); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <?php echo Form::label('numeroTarjeta', 'Numero de tarjeta:',['class'=>'label-bold']); ?>

                                    <input id="numeroTarjeta" type="text " class="form-control form-control-lg <?php echo e($errors->has('numeroTarjeta') ? ' is-invalid' : ''); ?>" name="numeroTarjeta" value="<?php echo e(old('numeroTarjeta')); ?>" required autofocus>
                                    <?php if($errors->has('numeroTarjeta')): ?>
                                        <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('numeroTarjeta')); ?></strong>
                                    </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::select('month_expiration',[1=>'Enero',2=>'Febrero',3=>'Marzo',4=>'Abril',5=>'Mayo',6,'Junio',7=>'Julio',8=>'Agosto',9=>'Septiembre',10=>'Octubre',11=>'Noviembre',12=>'Diciembre'],'',['placeholder'=>'Mes','class'=>'form-control form-control-lg','id'=>'month_expiration']); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::select('year_expiration',[21=>'2021',22=>'2022',23=>'2023',24=>'2024',25=>'2025'],'',['placeholder'=>'Año','class'=>'form-control form-control-lg','id'=>'year_expiration']); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <?php echo Form::label('nombreCompleto', 'Nombre del titular:'); ?>

                                    <input id="nombreCompleto" type="text"  value="" class="form-control form-control-lg <?php echo e($errors->has('nombreCompleto') ? ' is-invalid' : ''); ?>" name="nombreCompleto" placeholder="Como aparece en la tarjeta" required>
                                    <?php if($errors->has('nombreCompleto')): ?>
                                        <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('nombreCompleto')); ?></strong>
                                    </span>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php $__env->startSection("javascript"); ?>
    ...
    <script src="<?php echo e(asset('js/mi_cuenta/openpay/payment.js')); ?>"></script>
