    ...
    <section>
        <div class="container">
            ...
            <div class="row justify-content-center margin-50px-bottom sm-margin-30px-bottom">
                <div class="col-lg-8 col-sm-8">
                    <div class="row">
                        <div class="col-12 mb-2 d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(asset('eventos_views/residentes/PROGRAMA SEMINARIO.pdf')); ?>" target="_blank" class="btn btn-sm btn-actions"><i class="fa fa-download"></i> Descargar programa completo</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="https://bit.ly/seminario_residentes_03" target="_blank" class="btn btn-actions disabled btn-sm">Confirma tu asistencia</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>01/03/2021</td>
                ...
                <div class="col-sm-4">
                    <img src="<?php echo e(asset('eventos_views/residentes/image.jpeg')); ?>" style="border-radius: 3px;" alt="">
                </div>
            </div>
        </div>
    </section>
