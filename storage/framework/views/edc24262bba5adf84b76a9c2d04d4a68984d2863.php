<?php $__env->startSection('title','Pago de Anualidad'); ?>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-12 padding-50px-right md-padding-30px-right sm-padding-15px-right">
                    ...
                    <div class="single-sidebar-menu">
                        <ul class="no-margin">
                            <li><a href="<?php echo e(asset('atencion_socio/guias_clinicas')); ?>">Guías Clínicas</a></li>
                            <li><a href="<?php echo e(asset('atencion_socio/estatutos')); ?>">Estatutos</a></li>
                            <li class="active"><a href="<?php echo e(asset('atencion_socio/pago_anualidad')); ?>">Pago de Anualidad</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-12 sm-margin-20px-bottom">
                            <div class="pricing-list highlight">
                                ...
                                <div class="text-center margin-15px-bottom">
                                    <h4 class="text-white">CUOTA 2020</h4>
                                </div>
