                ...
                <div class="col-lg-4 col-md-5 col-sm-12 padding-50px-right md-padding-30px-right sm-padding-15px-right">
                    ...
                    <div class="single-sidebar-menu">
                        <ul class="no-margin">
                            ...
                            <li class="active"><a href="<?php echo e(asset('mi_cuenta/mis_datos_personales')); ?>">Editar información Personal</a></li>
                ...
                <div class="col-lg-8 col-md-7 col-sm-12">
                    ...
                    <div class="space30"></div>
                        <div class="bg-white padding-20px-all sm-padding-20px-all border border-width-5">
                            <?php echo Form::model($usuario,['url' => 'mi_cuenta/'.$usuario->idUsuario.'/update_mis_datos_personales', 'method' => 'PATCH',  'id' => 'FormEditarUsuario', 'class'=>'contact-form' ]); ?>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6 col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <?php echo Form::label('titulo', 'Titulo:',['class'=>'']); ?>
                                    ...
                                    <div class="form-group">
                                        <?php echo Form::label('nombre', 'Nombre:',['class'=>'']); ?>

                                        <?php echo Form::text('nombre',null,['class'=>'form-control ','placeholder'=>'Nombre']); ?>

                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('apellidoPaterno', 'Apellido Paterno:',['class'=>'']); ?>

                                        <?php echo Form::text('apellidoPaterno',null,['class'=>'form-control ','placeholder'=>'Apellido Paterno']); ?>

                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('apellidoMaterno', 'Apellido Materno:',['class'=>'']); ?>
                                    ...
                                    <div class="form-group">
                                        <?php echo Form::label('sexo', 'Sexo:',['class'=>'']); ?>

                                        <?php echo Form::select('sexo', array('M' => 'MASCULINO', 'F' => 'FEMENINO'),null, ['class' => 'form-control ']); ?>

                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('telOficina', 'Telefono Oficina:',['class'=>'']); ?>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <?php echo Form::label('email', 'E-mail:',['class'=>'']); ?>

                                        <?php echo Form::text('email',null,['class'=>'form-control ','placeholder'=>'E-mail']); ?>

                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::label('movil', 'Movil:',['class'=>'']); ?>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <?php echo Form::label('cedulaProfesional', 'Cedula Profesional:',['class'=>'']); ?>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <?php echo Form::label('cedulaEspecialidad', 'Cedula Especialidad:',['class'=>'']); ?>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <?php echo Form::label('lugarTrabajo', 'Lugar de Trabajo:',['class'=>'']); ?>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <?php echo Form::label('calle', 'Calle:',['class'=>'']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php echo Form::label('noExt', 'noExt:',['class'=>'']); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php echo Form::label('noInt', 'noInt:',['class'=>'']); ?>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php echo Form::label('codigoPostal', 'Código Postal:',['class'=>'']); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/mi_cuenta/mi_cuenta_mis_datos_personales.js')); ?>"></script>
<?php $__env->stopSection(); ?>
