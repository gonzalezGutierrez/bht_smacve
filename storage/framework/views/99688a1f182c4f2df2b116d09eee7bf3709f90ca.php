...
<head>
    ...
    <!-- custom css -->
    <link rel="stylesheet/less" type="text/css" href="<?php echo e(asset('less/template_01.less')); ?>" />
    <script src="<?php echo e(asset('libraries/less/less.min.js')); ?>" type="text/javascript"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 p-0">
                        ...
                        <div id="dropdownCAV2019" class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?php echo e(asset('merida_2020/costo_inscripcion')); ?>">Costo Inscripción</a>
                                <a class="dropdown-item" href="<?php echo e(asset('merida_2020/sede')); ?>">Sede del Evento</a>
                                <a class="dropdown-item" href="<?php echo e(asset('merida_2020/registro_online')); ?>">Registro Online</a>
                                <a class="dropdown-item" href="<?php echo e(asset('merida_2020/programa')); ?>">Programa Académico</a>
                                <a class="dropdown-item" href="<?php echo e(asset('merida_2020/profesores')); ?>">Profesores</a>
                                <a class="dropdown-item" href="<?php echo e(asset('pdf/convocatoria_trabajos_libres_2020.pdf')); ?>" target="_blank">Convocatoria Trabajos Libres</a>
                                <!--
                                <a class="dropdown-item" href="<?php echo e(asset('merida_2020/hoteles')); ?>">Hoteles Sub Sede</a>
                                -->
                            </div>
                        </div>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light no-padding">
                                ...
                                <div class="navbar-header navbar-header-custom">
                                    <a href="<?php echo e(asset('/')); ?>" class="navbar-brand">
                                        <img id="logo" src="<?php echo e(asset('images/logos/logo_smacve.png')); ?>" alt="SMACVE" /><span class="xs-display-none">Sociedad Mexicana de Angiología, Cirugía Vascular y Endovascular</span>
                                    </a>
                                </div>
                                ...
                                <ul class="navbar-nav ml-auto" id="nav" style="display: none;">
                                    ...
                                    <li id="btn-educacion_medica" class="btn-section"><a href="<?php echo e(asset('educacion_medica')); ?>">Educación</a></li>
                                    ...
                                    <li id="btn-eventos" class="btn-section"><a href="<?php echo e(asset('eventos')); ?>">Eventos</a></li>
                    ...
                    <div class="col-lg-4">
                        <div class="padding-30px-all sm-padding-25px-tb sm-no-padding-lr border-right border-color-light-white sm-no-border-right sm-border-bottom">
                            ...
                            <div class="d-inline-block vertical-align-top padding-10px-left width-75">
                                ...
                                <a href="<?php echo e(asset('atencion_socio/pago_anualidad')); ?>" class="no-margin line-height-normal">Cuota 2020: $3,600.00</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
...
<script src="<?php echo e(asset('js/template_01.js')); ?>" type="text/javascript"></script>
